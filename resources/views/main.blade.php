  ...
  <div class="container mt-5">
    <div class="card p-4 bg-primary">
      <div class="row align-items-center">
        <div class="col">
          <h4 class="mb-0 text-white">Get a Coupon</h4>
          <p class="mb-0 text-white-50">Get a discount with a minimum purchase of IDR 2,000,000.</p>
        </div>
        <div class="col-auto"><a class="btn btn-white text-primary shadow-0" href="#">Learn More</a></div>
      </div>
    </div>
  </div>
</section>
